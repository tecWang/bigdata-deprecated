...
select unix_timestamp('2019-9-4 11:23:00');         -- 1567596180
...
-- * 将一个字符串date按照"yyyy-MM-dd"格式转成日期值
select current_timestamp;                           -- 2024-09-10 16:26:01.706
select to_date(current_timestamp)                   -- 2024-09-10
